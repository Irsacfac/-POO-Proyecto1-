...
public class Jugador {
	...
	public void cambiarPosicion(int movimiento) {
		...
		if(inTablero) {
			...
			case 65:
				System.out.println(getNombre()+", tu pereza te hizo pensar que ibas más adelante. En realidad te encuentras en la casilla 50"+"\n");
				JOptionPane.showMessageDialog(null, getNombre()+", tu pereza te hizo pensar que ibas más adelante. En realidad te encuentras en la casilla 50");
			...
			case 99:
				System.out.println(getNombre()+", lleno de regosijo y jactandote de tus habilidades la sobervia te hace resvalar en tu momento de gloria, la vergüensa hace que te debuelvas a la casilla 15"+"\n");
				JOptionPane.showMessageDialog(null, getNombre()+", lleno de regosijo y jactandote de tus habilidades la sobervia te hace"+"\n"+"  resvalar en tu momento de gloria, la vergüensa hace que te debuelvas a la casilla 15");
